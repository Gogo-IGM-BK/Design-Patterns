...
build_dir="./tmp_build"
src_dir="./src"
jarname="CoolGraphicFactory.jar"
interface_provided="fr.uge.poo.paint.ex8.factory.CanvasFactory"
class_providing_the_interface="fr.uge.poo.paint.ex8.factory.CoolGraphicAdapterFactory"
included_classes=("com.evilcorp.coolgraphics.CoolGraphics" "fr.uge.poo.paint.ex8.CoolGraphicAdapteur" "$interface_provided" "$class_providing_the_interface")
